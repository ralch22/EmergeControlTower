...
import { clientScope } from "./middleware/client-scope";
...
// Resolve workspace scope (req.clientId) from the X-Client-Id header /
// body before any route handler runs. See middleware/client-scope.ts.
app.use(clientScope);
